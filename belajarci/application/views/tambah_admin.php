               ...
               <div class="row">
                ...
                <script>
                  function validateForm() {
                      ...
                      var c = document.forms["myForm"]["nama"].value;
                ...
                <form name="myForm" onsubmit="return validateForm()" action="act_admin_tambah" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="exampleInputJudul">Username</label>
                    <input type="text" name="username" class="form-control" placeholder="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputJudul">Password</label>
                    <input type="password" name="password" class="form-control" placeholder="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputJudul">Level</label>
                    <input type="number" name="level" class="form-control" placeholder="">
                  </div>
                  <div class="form-group">
