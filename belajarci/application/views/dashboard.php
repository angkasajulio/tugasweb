        ...
        <div id="wrapper">
        	<div id="page-wrapper">
        		<div class="row">
					...
					Selamat Datang di Admin Page<p>
						Berikut adalah penjelasan singkat tentang admin Page ini
						<ol>
							<li>Tab <strong>Dashboard</strong> adalah penjelasan singkat tentang web</li>						
							<li>Tab <strong>Admin</strong> untuk menambah, edit dan delete <strong>Admin</strong> yang memiliki level 1 adalah yang tertinggi</li>							
							<li><strong>Logout</strong> digunakan untuk mengakhiri penggunaan <strong>Admin Page</strong></li>
						</ol>
	        		</div>
         </div>
        <!-- /#wrapper -->
